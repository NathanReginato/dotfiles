...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%246F'  # dragonGray  #a6a69c
      local      clean='%108F'  # dragonGreen #87a987
      local   modified='%180F'  # dragonYellow #c4b28a
      local  untracked='%110F'  # dragonBlue  #8ba4b0
      local conflicted='%174F'  # dragonRed   #c4746e
    else
      # Stale / loading: muted dragonGray3.
      local       meta='%244F'
      local      clean='%244F'
      local   modified='%244F'
  ...
  ################[ todo: todo items (https://github.com/todotxt/todo.txt-cli) ]################
  # Todo color.
  typeset -g POWERLEVEL9K_TODO_FOREGROUND=139
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=174
